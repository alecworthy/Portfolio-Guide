...
| Project Name                    | Completion date | Project Link                  | Description                                                                                        |
|---------------------------------|-----------------|-------------------------------|----------------------------------------------------------------------------------------------------|
| Study of Bitcoin                    | May 2025        |      [View](https://github.com/alecworthy/Bitcoin-Price-Trend-Volatility-Analysis/blob/main/README.md)                     | Analysed historical Bitcoin price data to identify trends, volatility, and key market movements using structured spreadsheet analysis. Skills used: Excel, VLOOKUP, Pivot Tables, Line Charts.                                                                                                                                             
